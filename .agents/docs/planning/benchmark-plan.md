...
The pmndrs/glyph lab extends that pattern with correctness hashes, image diffs, cold-start automation, raw sample export, GPU/device metadata, and font/raster byte accounting.
...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Application            | A Vite browser application under `benches`; it remains locally runnable and statically publishable.                                                                                                                                                                                                                |
...
The planned repository keeps target adapters, scenarios, harness policy, UI, bundle-size entries, and result schemas as separate modules under `benches`; the exact directory names are implementation details rather than a second architecture contract.
