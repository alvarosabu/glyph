...
```ts
import { defineRasterFormat, defineRasterResourceId } from '@pmndrs/glyph/core';
...
import { f32, techniqueProgram } from '@pmndrs/glyph/core';
...
- raster-format and renderer production code use root application types, `/core` helpers, and explicit
