...
```ts
import { defineRasterFormat, defineRasterResourceId } from '@pmndrs/glyph/extend';
...
import { defineTechniqueSchema } from '@pmndrs/glyph/extend';
...
import { f32, techniqueProgram } from '@pmndrs/glyph/extend';
...
- raster-format and renderer production code use root application types, `/extend` helpers, and explicit
