...
- uses only public application types from `@pmndrs/glyph`, renderer-neutral helpers from `/core`, and explicit
...
The root package exposes every application-visible integration type. The `/core` entry exposes construction
...
import { defineGlyphSchema } from '@pmndrs/glyph/core';
...
import { id } from '@pmndrs/glyph/core';
import { createRasterCodecProgram } from '@pmndrs/glyph/core';
import { defineCodecBuffers } from '@pmndrs/glyph/core';
...
1. **Package boundary:** application types come from `@pmndrs/glyph`; construction helpers come from public
   `/core` entry; raster-format and shader code uses its explicit subpaths.
