/* @workflow { "name": "benchmark:presentation-screenshots", "summary": "Capture verified Presentation screenshots for every workload and backend.", "requirements": "GPU-enabled Chromium and authenticated benchmark fixtures.", "writes": "Ignored benches/.cache/presentation-screenshots files." } */
