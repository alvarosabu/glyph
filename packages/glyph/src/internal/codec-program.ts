...
import type { RasterTextEffect } from '../config/raster-format.js';
import type { CodecBufferId, CodecInput, CodecInputScope, CodecOperation } from '../config/codec.js';
import type {
...
import { recordTechniqueCodecBody } from './codec-program-contract.js';
...
type CodecLaneTuple<Scalar extends CodecScalarKind, Lanes extends readonly string[]> = Lanes extends readonly [
  string,
...
export type TechniqueCodecStores<Buffers extends CodecBufferDeclarations> = {
...
export interface TechniqueCodecProgramBuilder<
  ...
  Buffers extends CodecBufferDeclarations,
  F32 extends readonly string[],
  U32 extends readonly string[],
> {
  readonly semantics: CodecProgramSemantics;
...
/** Build the host's absolute decoration-row program; raster codecs use `techniqueProgram`. */
